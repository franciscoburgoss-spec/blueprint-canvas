...
describe('Autocomplete System', () => {
  describe('getSuggestions - comandos base', () => {
    ...
    it('no debe sugerir si no empieza con /', () => {
      const suggestions = getSuggestions('texto normal');
      expect(suggestions.length).toBe(0);
    });

    it('no debe sugerir si el input está vacío', () => {
      const suggestions = getSuggestions('');
      expect(suggestions.length).toBe(0);
    });
  ...
  describe('getSuggestions - contexto de documentos', () => {
    ...
    it('debe sugerir documentos existentes para /doc', () => {
    ...
    it('debe sugerir documentos para /obs', () => {
  ...
  describe('getSuggestions - contexto de observaciones', () => {
    ...
    it('debe sugerir IDs de observaciones para /approve', () => {
    ...
    it('debe sugerir IDs de observaciones para /reject', () => {
      const suggestions = getSuggestions('/reject ', mockContext);
      const obsSuggestions = suggestions.filter(s => s.category === 'observación');
      expect(obsSuggestions.length).toBe(2);
    });

    it('debe sugerir IDs de observaciones para /edit', () => {
  ...
  describe('getSuggestions - tipos de observación', () => {
    ...
    it('debe sugerir tipos de observación para /obs DOC', () => {
  ...
  describe('getSuggestions - prioridades', () => {
    ...
    it('debe sugerir prioridades para /priority OBS-ID', () => {
  ...
  describe('getSuggestions - filtros', () => {
    it('debe sugerir type y status para /filter', () => {
    ...
    it('debe sugerir estados para /filter status', () => {
  ...
  describe('getSuggestions - listados', () => {
    it('debe sugerir items para /list', () => {
    ...
    it('debe sugerir items para /delete', () => {
  ...
  describe('Validación de estructura', () => {
    it('todas las sugerencias deben tener la estructura correcta', () => {
      const suggestions = getSuggestions('/');
    ...
    it('no debe haber más de 8 sugerencias', () => {
      const suggestions = getSuggestions('/');
      expect(suggestions.length).toBeLessThanOrEqual(8);
    });

    it('COMMANDS debe tener al menos 20 comandos definidos', () => {
      expect(COMMANDS.length).toBeGreaterThanOrEqual(20);
    });

    it('Cada comando debe tener cmd, desc y category', () => {
